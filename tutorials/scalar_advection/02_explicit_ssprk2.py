#!/usr/bin/env python3
"""Meme advection scalaire, avec SSPRK2 ecrit explicitement dans pops.Program.

Le script reste top-level et lineaire. Les expressions Python construisent le graphe temporel;
les stages et les operateurs sont ensuite compiles et executes en C++/Kokkos.
"""
...
RESULT_FILE = HERE / "results" / "02_explicit_ssprk2.npz"
