"""PF-08 reflux / AMR sync oracle: closed with reflux, open without.

Same already-reduced AM-09 ledger. Ratio-2 coarse-fine face: two fine
subfaces restrict to their average. The leftover storage change equals
that flux mismatch. Task 16 ``conservation_residual`` is closed only
when the reflux term is present. Elapsed wall time is an observation,
not part of this oracle.
