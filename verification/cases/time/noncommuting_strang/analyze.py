"""TM-02 analysis from native fields; fail-closed without Kokkos output."""
...
SUITE = "pr"
COMPONENT = "time"
BLOCKER = ('official Euler subflows cannot prove required Lie-1/Strang-2; native dt campaign not authenticated')
...
def write_tm02_report(output_dir, *, native=None, request=None) -> dict:
