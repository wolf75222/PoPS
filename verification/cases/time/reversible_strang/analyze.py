"""TM-08 analysis from native fields; fail-closed without Kokkos output."""
...
SUITE = "pr"
COMPONENT = "time"
BLOCKER = ('TM-08 SSPRK2 advection is not the required reversible Strang program')
...
def write_tm08_report(output_dir, *, native=None, request=None) -> dict:
