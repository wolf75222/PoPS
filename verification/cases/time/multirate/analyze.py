"""TM-06 analysis from native fields; fail-closed without Kokkos output."""
...
SUITE = "pr"
COMPONENT = "time"
BLOCKER = ('no native Kokkos output; exact-vs-exact and synthetic identities are not scientific evidence')
...
def write_tm06_report(output_dir, *, native=None, request=None) -> dict:
