"""EU-04 driver: in-memory exact vs exact, campaign report."""
...
NOT_APPLICABLE = {
    ...
    "amr.*": "AMR not run for EU-04 in-memory path",
    "poisson.*": "Poisson not run for EU-04",
    "coupling.*": "coupling not run for EU-04",
    "parallel_invariance.*": "parallel invariance not run for EU-04",
    "performance.one_node": "performance not measured for EU-04 in-memory path",
    "performance.two_node": "performance not measured for EU-04 in-memory path",
}
ARTIFACTS = {
    "report_md": "REPORT.md",
...
def write_eu04_report(output_dir) -> dict:
