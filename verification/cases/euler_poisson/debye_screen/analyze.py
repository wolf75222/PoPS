"""CP-09 analysis from native fields; fail-closed without Kokkos output."""
...
BLOCKER = ('CP-09 screened Helmholtz has no public whole-system Program; required fail')
...
def write_cp09_report(output_dir, *, native=None, request=None) -> dict:
