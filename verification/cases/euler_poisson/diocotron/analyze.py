"""CP-11 analysis from native fields; fail-closed without Kokkos output."""
...
BLOCKER = ('CP-11 ExB diocotron growth is not on the public 2-d Euler Case; required fail')
...
def write_cp11_report(output_dir, *, native=None, request=None) -> dict:
