"""CP-06 analysis from native fields; fail-closed without Kokkos output."""
...
BLOCKER = ('CP-06 unscreened ion-sound toy is not the required ion-acoustic+Poisson eigenmode')
...
def write_cp06_report(output_dir, *, native=None, request=None) -> dict:
