"""CP-04 analysis from native fields; fail-closed without Kokkos output."""
...
BLOCKER = ('CP-04 2-d Euler-Poisson field coupling is not on the public Case')
...
def write_cp04_report(output_dir, *, native=None, request=None) -> dict:
