"""CP-10 analysis from native fields; fail-closed without Kokkos output."""
...
BLOCKER = ('CP-10 self-gravity is not injected on the public Euler Case')
...
def write_cp10_report(output_dir, *, native=None, request=None) -> dict:
