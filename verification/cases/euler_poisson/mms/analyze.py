"""CP-01 analysis from native fields; fail-closed without Kokkos output."""
...
BLOCKER = ('CP-01 manufactured hyperbolic sources and Poisson coupling are not on the public Case')
...
def write_cp01_report(output_dir, *, native=None, request=None) -> dict:
