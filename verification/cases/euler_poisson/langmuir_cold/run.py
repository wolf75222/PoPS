...
def initial_fields(n_cells: int = N_CELLS, t: float = 0.0):
    """Closed-form n_e, u_e, E, φ at one time on the uniform grid."""
...
def run_native(n_cells: int = N_CELLS, t_end: float = 0.05, *, request=None):
    ...
    simulation = bind_public(artifact, initial_values={authored.instance: initial}, mpi_mode=require_bind_request(request, NativeUnavailable, 'CP-02'))
