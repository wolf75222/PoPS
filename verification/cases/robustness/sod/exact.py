"""Classic 1-d Sod shock-tube exact Riemann oracle.

Left (rho, u, p) = (1, 0, 1), right (0.125, 0, 0.1), gamma=1.4.
Diaphragm at x0=0.5 on the unit interval. Evaluation time t=0.2.
...
Sod has a left rarefaction, contact, and right shock. Does not import
...
def primitives_1d(x, t) -> np.ndarray:
    """Exact Sod primitives W=(rho, u, p). Shape (3, n)."""
