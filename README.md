...
![Tests](https://img.shields.io/badge/tests-50%2F50%20C%2B%2B%20%2B%209%20MPI%20%2B%20python-brightgreen)
...
- **50/50** tests C++ (serie), idem OpenMP ; **+9** MPI (`mpirun -np 4`, bit-identique a np=1/2/4) ; **+1** HDF5 ; bindings Python verts.
