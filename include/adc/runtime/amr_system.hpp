...
struct AmrBuildParams {
  ...
  // regenerated loader marshals pos_floor (adc_install_native_amr) into add_compiled_model ->
...
class AmrSystem {
 public:
  ...
  ///                 regenerated against this header marshals the floor (adc_install_native_amr).
  ...
  ///             carries it (adc_install_native_amr -> add_compiled_model -> set_compiled_block), so a
