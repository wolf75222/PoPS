...
///
/// Each policy is a stateless ADC_HD functor satisfying the contract:
...
/// cell values (NoSlope) this path is ALGEBRAICALLY identical to HLLFlux. ADC_HD.
template <class Model>
...
/// F* = F_k + s_k (U*_k - U_k) without any layout assumption. Both methods must be ADC_HD (called
/// in the kernels).
template <class M>
