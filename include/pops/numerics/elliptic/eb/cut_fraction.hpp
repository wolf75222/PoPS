...
/// This primitive is header-only, POPS_HD (device-safe) and STATELESS: it takes a level-set
...
POPS_HD inline ShortleyWellerWeights shortley_weller(const CutFraction& cf) {
