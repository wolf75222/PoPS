...
#include <pops/coupling/schur/core/schur_condensation.hpp>  // ElectrostaticLorentzCondensation (builder #124)
#include <pops/coupling/schur/core/schur_source_kernels.hpp>  // shared geometry-free kernels + validate_krylov_params (#263)
...
// live in <pops/coupling/schur/schur_source_kernels.hpp> and are shared with the polar / AMR steppers (#263).
