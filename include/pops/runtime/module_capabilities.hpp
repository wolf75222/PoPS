...
inline std::vector<CapabilityRouteReport> native_capability_routes(
  ...
  return {
      ...
      capability_route("checkpoint:uniform_accepted_state_v5", "available",
                       ...
                       "host|mpi", mpi, gpu),
      capability_route(
          "checkpoint:amr_accepted_state_v6", "available",
      ...
      capability_route("checkpoint:parallel_hdf5", "unavailable",
                       ...
                       "strict accepted-state NPZ checkpoint (uniform v5, AMR v6)",
      ...
      capability_route("checkpoint:amr_dynamic_regrid", status_from_bool(caps.supports_amr),
                       "strict v6 accepted-state restart; non-Dense history replay keeps rank "
                       "count",
