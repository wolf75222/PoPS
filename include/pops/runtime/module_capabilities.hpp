...
inline std::vector<CapabilityRouteReport> native_capability_routes(
  ...
  return {
      ...
      capability_route("riemann:hllc", "available",
                       "requires exact HLLC model capabilities on every geometry",
                       kLayoutRouteTokensCsv, "production", "host", mpi, gpu),
      capability_route("riemann:roe", "available",
                       "requires exact Roe dissipation capability on every geometry",
                       kLayoutRouteTokensCsv, "production", "host", mpi, gpu),
      ...
      capability_route("limiter:mc", "available",
                       "native POPS_HD MC slope policy; formal_order=2; ghost_depth=2",
                       kLayoutRouteTokensCsv, "production", "host", mpi, gpu),
      capability_route("limiter:superbee", "available",
                       "native POPS_HD Superbee slope policy; formal_order=2; ghost_depth=2",
                       kLayoutRouteTokensCsv, "production", "host", mpi, gpu),
      capability_route("elliptic:cartesian_cg", "available",
      ...
      capability_route(
          ...
          "independent conservative face apertures from that cube triangulation. Distributed "
