...
`POPS_DSL_OPTFLAGS='-O3 -DNDEBUG'`. Les essais diagnostiques à optimisation
réduite qui plantent CICC restent archivés comme échecs et ne remplacent jamais
la campagne déclarée. Cette politique ne réduit aucun point, répétition ou
taille du workload. Une
