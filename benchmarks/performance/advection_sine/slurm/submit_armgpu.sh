...
test "$("${POPS_PERF_LOGIN_PYTHON}" -B "${HARNESS_DIR}/validate_campaign.py" "${CAMPAIGN}" --field platform)" = armgpu
...
KOKKOS_SOURCE="${POPS_KOKKOS_CUDA_SOURCE:-${POPS_PERF_SUBMIT_HOME}/adc_gpu_p1/kokkos}"
