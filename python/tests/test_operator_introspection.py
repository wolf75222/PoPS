"""Spec 2 (S2-5): operator introspection on a Module, a dsl.Model and a CompiledProblem.
...
def test_dsl_model_introspection():
    ...
    print("OK  dsl.Model introspection")
...
def test_compiled_problem_introspection():
    ...
    compiled = dsl.CompiledProblem(so_path="<not built>", program=P, model=m,
    ...
    bare = dsl.CompiledProblem(so_path="x", program=P, model=None,
