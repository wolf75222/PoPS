...
def anisotropic_epsilon_tests():
    ...
    s_iso._add_block("q", model=_charge_scalar(), spatial=pops.Spatial(limiter=pops.numerics.reconstruction.FirstOrder()))
    s_iso._set_poisson(rhs="charge_density", solver="geometric_mg", bc="dirichlet")
