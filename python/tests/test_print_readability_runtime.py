...
The inert architecture gate ``tests/architecture/test_print_readability.py`` asserts the print
...
the ``gate-python`` step, which executes ``python/tests/test_*.py`` AFTER the ``_pops`` module is
