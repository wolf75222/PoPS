...
def test_surface_matrix_does_not_use_direct_legacy_bindings():
    ...
    targets = [
        Path(__file__),
        ROOT / "python/tests/test_fv_hll_minmod.py",
        ROOT / "python/tests/test_spec5_validation_gaps.py",
        ROOT / "python/tests/test_spec5_native_capabilities.py",
        ROOT / "python/tests/test_runtime_inspection_reports.py",
        ROOT / "python/tests/test_program_runtime_params.py",
    ]
