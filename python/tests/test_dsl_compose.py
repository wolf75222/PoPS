...
quelle brique manuelle. On l'insere dans un adc::CompositeModel<EulerGen, NoSource, ChargeDensity> et
on exige : (1) static_assert(adc::PhysicalModel<Gen>) et static_assert(adc::HyperbolicModel<EulerGen>)
...
static_assert(adc::PhysicalModel<Gen>, "compose genere non conforme au concept PhysicalModel");
static_assert(adc::PhysicalModel<Ref>, "compose oracle non conforme (setup du test)");
