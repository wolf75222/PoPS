...
ROUTE_REGISTRY_SIGNATURE = 'v2:5495e704069ee2a74808c5c1c12c626e9453cd729c23b2dde0291884ec538f90'
...
ROUTE_TABLES = {'riemann': (('rusanov', 'pops::RusanovFlux', ('max_wave_speed',), ()),
 ...
 'splitting': (('lie', 'pops::SystemStepper(lie)', (), ()),
               ('strang',
                'pops::SystemStepper(strang)',
                (),
 ...
 'source_stage': (('electrostatic_lorentz',
                   'pops::ElectrostaticLorentzCondensedSchur',
                   ('magnetic field B_z', 'system potential phi'),
                   ('theta in (0, 1]',)),),
...
ROUTE_CPP_BINDINGS = {'riemann': {'enum': 'RiemannRouteId',
 ...
 'splitting': {'enum': 'SplittingRouteId', 'table': 'kSplittingRoutes', 'ids': ('kLie', 'kStrang')},
 ...
 'source_stage': {'enum': 'SourceStageRouteId',
                  'table': 'kSourceStageRoutes',
                  'ids': ('kElectrostaticLorentz',)},
...
ROUTE_FAMILY_INTERFACES = {'riemann': [{'name': 'requirement', 'mode': 'value', 'binding': 'requirements'},
 ...
 'time': [{'name': 'requirement', 'mode': 'value', 'binding': 'requirements'},
          ...
          {'name': 'report', 'mode': 'method', 'binding': 'manifest'}],
 'splitting': [{'name': 'requirement', 'mode': 'value', 'binding': 'requirements'},
               {'name': 'lowering', 'mode': 'entry_point', 'binding': 'native'},
 ...
 'elliptic': [{'name': 'requirement', 'mode': 'value', 'binding': 'requirements'},
              ...
              {'name': 'fallible_evaluation', 'mode': 'entry_point', 'binding': 'native'},
              {'name': 'report', 'mode': 'method', 'binding': 'manifest'}],
 'source_stage': [{'name': 'requirement', 'mode': 'value', 'binding': 'requirements'},
                  {'name': 'stability', 'mode': 'entry_point', 'binding': 'native'},
                  {'name': 'lowering', 'mode': 'entry_point', 'binding': 'native'},
                  {'name': 'fallible_evaluation', 'mode': 'entry_point', 'binding': 'native'},
                  {'name': 'restart', 'mode': 'entry_point', 'binding': 'native'},
