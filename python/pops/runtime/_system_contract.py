...
class _System:
    ...
    _s: Any
    _pending_native_packages: int
    _batch_native_packages: bool
    _step_strategy: Any
    ...
    def stage_auxiliary_input(self, *args: Any, **kwargs: Any) -> Any: ...
    def auxiliary_component(self, *args: Any, **kwargs: Any) -> Any: ...
