...
def _inventory_rows(flags: Any, source: Any) -> list:
    ...
    return [
        ...
        _row(
            ...
            available_route="strict accepted-state v4 NPZ checkpoint",
        ...
        _row(
            ...
            mpi=mpi,
            limitation=(
                "strict v4 accepted-state restart; exact rank-local AMR ownership and "
