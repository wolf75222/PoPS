"""pops.mesh -- typed mesh / geometry / AMR descriptors (Spec 5 sec.5.9-5.11).

``pops.mesh`` describes the discrete domain and the objects the runtime materialises. It
contains no physics and no solver. Layout descriptors live in :mod:`pops.layouts`; this package
owns meshes, geometry, AMR policies and layout-plan internals.
descriptors:
...
from . import amr, geometry, masks, boundaries
