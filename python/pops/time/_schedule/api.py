...
from pops.time._schedule.domains import (
    AMRLevel,
    AcceptedStep,
    Attempt,
    ClockTick,
...
from pops.time._schedule.ir import (
    ScheduleAction,
    ScheduleComment,
    ScheduleDomainIR,
    ScheduleDueIR,
...
@stable_component_identity("pops://time/schedule/off-policies/hold")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/off-policies/skip")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/off-policies/zero")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/off-policies/accumulate-dt")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/off-policies/error")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule")
@dataclass(frozen=True, slots=True)
class Schedule:
