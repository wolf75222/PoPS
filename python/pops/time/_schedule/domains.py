...
from pops.time._schedule.ir import ScheduleDomainIR, ScheduleTimeline
from pops.time._schedule.protocol import (
    component_payload,
    manifest_value,
    map_component,
...
@stable_component_identity("pops://time/schedule/domain")
...
@stable_component_identity("pops://time/schedule/domains/accepted-step")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/domains/attempt")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/domains/clock-tick")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/domains/amr-level")
@dataclass(frozen=True, slots=True)
...
@stable_component_identity("pops://time/schedule/event-handle")
@dataclass(frozen=True, slots=True)
class EventHandle:
...
@stable_component_identity("pops://time/schedule/domains/event")
@dataclass(frozen=True, slots=True)
class Event(Domain):
