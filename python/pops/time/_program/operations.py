...
from pops.time._program.calls import _ProgramCall
from pops.time._program.clocks import _ProgramClocks
from pops.time._program.rhs import _ProgramRhs
...
class _ProgramCore(
    ...
    :class:`pops.time._program.calls._ProgramCall` (split for the 500-line cap, ADC-550).
    """
