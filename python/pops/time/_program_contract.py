...
class _ProgramBase:
    ...
    def _rebuild_time_handle_tables(self, out: Any, idmap: Any,
                                    representative: Any, reference_of: Any = None) -> None: ...
    ...
    def solve_residual(self, residual: Any, *, initial: Any, solver: Any = None,
                       preconditioner: Any = None, name: Any = None, at: Any = None,
                       **options: Any) -> Any: ...
