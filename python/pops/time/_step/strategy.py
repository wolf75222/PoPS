"""Typed, inert macro-step strategy descriptors.

Strategies are immutable authoring descriptors.  They validate their complete runtime-control
schema but never materialize execution objects. Runtime adapters own controller construction and
the native executor owns numerical work. No ``run`` keyword may infer or replace a strategy.
"""
...
class StepStrategy:
    """Registered, serializable authoring protocol for macro-step policy descriptors."""
