"""Shared analytic-expression lowering for compiler and bind-time consumers.

This pure transformation authenticates canonical data and returns native postfix programs;
it neither imports the execution runtime nor constructs a native runtime object.
"""
