"""pops._ir.ops -- free-function constructors for the flux-DSL and board AST.
...
SQRT NAME CLASH RESOLUTION
  ...
  here and in ``pops._ir.__init__``.  The board ``sqrt`` from pops.math is exposed
...
def div(flux: Any) -> Any:
    ...
    :class:`~pops._ir.expr.DivCoeffGrad` (Spec 5 sec.9.2 ``-div(eps grad phi)``).
    """
