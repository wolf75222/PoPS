...
public home for the solver descriptors. Every entry is an inert
...
# factory namespace. It intentionally exposes only compiled solver descriptors, never custom-solver
# authoring hooks.
