...
https://github.com/google/styleguide/blob/gh-pages/docguide/best_practices.md (gh-pages branch).
...
How we apply it locally: docs/sphinx/development/documentation.md and CONTRIBUTING.md.
-->
