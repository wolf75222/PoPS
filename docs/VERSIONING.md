...
- Python bindings: the documented `pops.*` surface (`pops.System`,
  `pops.AmrSystem`, `pops.physics.Model`, the package-scoped descriptor classes,
  `pops.doctor`, `pops.set_threads`,
