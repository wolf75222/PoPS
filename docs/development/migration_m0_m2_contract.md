...
| --- | --- | --- |
| Scalar AMR | `examples/final/EXEMPLE_SPEC_FINALE_ADVECTION_SCALAIRE_COMPLET.py` and its test; include leaf-cell error, every-level synchronization, completed regrid, declared dimensions/backends/ranks, and restart/output cells | `docs/tutorials/scalar_advection/06_openmp_amr_explicit_ssprk2.py`, `08_mpi_amr_explicit_ssprk2.py`, `10_openmp_amr_synchronous_ssprk2.py`, `13_openmp_amr_restart.py`, `16_openmp_cartesian3d_ssprk2.py` |
