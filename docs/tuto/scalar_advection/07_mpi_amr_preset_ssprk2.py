#!/usr/bin/env python3
"""Advection scalaire 2D avec AMR, MPI natif et le preset SSPRK2.

Le script ne depend pas de mpi4py. Python decrit le cas puis PoPS distribue la hierarchie et
execute les operateurs en C++/Kokkos sous MPI_COMM_WORLD.
"""
...
# 3. Volumes finis : aucun calcul par cellule n'est effectue en Python.
...
# 7. Hierarchie 2:1, tagging symbolique, transfert conservatif et subcycling 2:1.
