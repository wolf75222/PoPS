...
| Report | Axis | Linear |
| --- | --- | --- |
| [CODEBASE_AUDIT.md](archive/CODEBASE_AUDIT.md) | maintainability of the codebase | ADC-189/190/191 |
| [STYLE_CONFORMANCE_AUDIT.md](archive/STYLE_CONFORMANCE_AUDIT.md) | conformance to C++ standards | ADC-124 |
| [COMMENTS_AUDIT.md](archive/COMMENTS_AUDIT.md) | accuracy of comments | ADC-125 |
| [PERF_SCALING_FRONTENDS_AUDIT_2026-06-08.md](PERF_SCALING_FRONTENDS_AUDIT_2026-06-08.md) | performance and scaling | ADC-193 |
| [TOOLCHAIN_ROBUSTESSE_AUDIT_2026-06-10.md](archive/TOOLCHAIN_ROBUSTESSE_AUDIT_2026-06-10.md) | toolchain and install robustness | toolchain hardening |
| [CONFORMANCE_AUDIT.md](archive/CONFORMANCE_AUDIT.md) | spec & requirement conformance | ADC-188 |
| [STL_BOOST_AUDIT.md](archive/STL_BOOST_AUDIT.md) | STL idiom & Boost decision | ADC-192 |
| [DOC_REFONTE_AUDIT.md](archive/DOC_REFONTE_AUDIT.md) | documentation truth matrix | ADC-146 |
...
- ADC-188 -- Conformance to specs & requirements: NEW report [CONFORMANCE_AUDIT.md](archive/CONFORMANCE_AUDIT.md). Contracts mostly hold (step ordering, explicit guards, model-agnostic core); two real spec<->code divergences: stale "multi-block AMR + regrid_every>0 is REFUSED" claim (now implemented/tested) and silent elliptic-Poisson non-convergence.
- ADC-189 -- Flexible architecture: COVERED by [CODEBASE_AUDIT.md](archive/CODEBASE_AUDIT.md) (+ GENERICITY_2026-06.md). Bricks are unit-testable; the prior P0 god-class is substantially resolved (Lot B). Two Low post-snapshot watch-items tracked as issues.
- ADC-190 -- Anti-patterns (duplication etc.): PARTIALLY COVERED by [CODEBASE_AUDIT.md](archive/CODEBASE_AUDIT.md) (pre-dates the polar Schur stepper / multi-box theta path). Two net-new Medium duplications tracked as issues.
- ADC-191 -- Simplification / LOC: PARTIALLY COVERED by [CODEBASE_AUDIT.md](archive/CODEBASE_AUDIT.md) (coarse extraction, now done). Two net-new Low behavior-preserving factor-outs tracked as issues.
- ADC-192 -- STL & Boost: NEW report [STL_BOOST_AUDIT.md](archive/STL_BOOST_AUDIT.md). Boost = NO (0 hits). STL host code is clean; 3 Low sites tracked. TOOLCHAIN_ROBUSTESSE is build-robustness only, no STL/Boost content.
