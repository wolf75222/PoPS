...
# Chaque boite contient (niveau, borne_basse, borne_haute) ; les bornes sont des tuples.
continuous_patches = tuple(simulation.patch_boxes())
restarted_patches = tuple(resumed.patch_boxes())
...
np.testing.assert_equal(continuous_patches, restarted_patches)
