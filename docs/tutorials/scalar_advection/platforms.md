...
|---|---|---|
| Uniforme, OpenMP | [`01_openmp_preset_ssprk2.py`](01_openmp_preset_ssprk2.py) | [`02_openmp_explicit_ssprk2.py`](02_openmp_explicit_ssprk2.py) |
| Uniforme, MPI natif | [`03_mpi_preset_ssprk2.py`](03_mpi_preset_ssprk2.py) | [`04_mpi_explicit_ssprk2.py`](04_mpi_explicit_ssprk2.py) |
| AMR, OpenMP | [`05_openmp_amr_preset_ssprk2.py`](05_openmp_amr_preset_ssprk2.py) | [`06_openmp_amr_explicit_ssprk2.py`](06_openmp_amr_explicit_ssprk2.py) |
...
## OpenMP : nombre de threads explicite
...
Un thread est utilise par defaut ; `export POPS_THREADS=4` en demande quatre.
Le bilan final affiche le backend Kokkos charge. Les scripts se lancent sans argument :

```bash
python docs/tutorials/scalar_advection/01_openmp_preset_ssprk2.py
python docs/tutorials/scalar_advection/02_openmp_explicit_ssprk2.py
python docs/tutorials/scalar_advection/05_openmp_amr_preset_ssprk2.py
python docs/tutorials/scalar_advection/06_openmp_amr_explicit_ssprk2.py
python docs/tutorials/scalar_advection/09_openmp_amr_gradient_ssprk2.py
python docs/tutorials/scalar_advection/10_openmp_amr_synchronous_ssprk2.py
python docs/tutorials/scalar_advection/11_openmp_runtime_parameters.py
python docs/tutorials/scalar_advection/12_openmp_amr_outputs.py
python docs/tutorials/scalar_advection/13_openmp_amr_restart.py
```
...
```bash
python docs/tutorials/scalar_advection/plot_openmp_results.py
```
...
```bash
mpiexec -n 2 python docs/tutorials/scalar_advection/03_mpi_preset_ssprk2.py
mpiexec -n 2 python docs/tutorials/scalar_advection/04_mpi_explicit_ssprk2.py
mpiexec -n 2 python docs/tutorials/scalar_advection/07_mpi_amr_preset_ssprk2.py
mpiexec -n 2 python docs/tutorials/scalar_advection/08_mpi_amr_explicit_ssprk2.py
POPS_PARAVIEW_ROOT=/Applications/ParaView-6.1.1.app \
  mpiexec -n 2 python docs/tutorials/scalar_advection/14_mpi_amr_outputs.py
```
...
POPS_CATALYST=1 scripts/paraview_python.sh --mpi 2 \
  docs/tutorials/scalar_advection/14_mpi_amr_outputs.py
```
...
srun --ntasks=4 --cpus-per-task=1 \
  python docs/tutorials/scalar_advection/03_mpi_preset_ssprk2.py
srun --ntasks=4 --cpus-per-task=1 \
  python docs/tutorials/scalar_advection/04_mpi_explicit_ssprk2.py
srun --ntasks=4 --cpus-per-task=1 \
  python docs/tutorials/scalar_advection/07_mpi_amr_preset_ssprk2.py
srun --ntasks=4 --cpus-per-task=1 \
  python docs/tutorials/scalar_advection/08_mpi_amr_explicit_ssprk2.py
```
