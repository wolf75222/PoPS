...
suite lineaire du script declare explicitement l'etat
...
mpiexec -n 2 python docs/tutorials/hyqmom/01_openmp_diocotron_hll.py
mpiexec -n 2 python docs/tutorials/hyqmom/02_openmp_constant_hll.py
mpiexec -n 2 python docs/tutorials/hyqmom/03_openmp_fluid_wave_hll.py
mpiexec -n 2 python docs/tutorials/hyqmom/04_openmp_electrostatic_wave_hll.py
mpiexec -n 2 python docs/tutorials/hyqmom/05_openmp_magnetic_wave_hll.py
mpiexec -n 2 python docs/tutorials/hyqmom/06_openmp_shock_tube_hll.py
mpiexec -n 2 python docs/tutorials/hyqmom/07_openmp_crossing_jets_hll.py
```

`POPS_THREADS` fixe les threads OpenMP de chaque rang (un par defaut). Le total demande ici
...
```bash
PVD=$(find docs/tutorials/hyqmom/results/01_openmp_diocotron_hll_amr \
...
```bash
python docs/tutorials/hyqmom/plot_openmp_results.py
```
