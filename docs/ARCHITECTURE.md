...
`tests/cpp/support/reference_system_driver.hpp`; no installed header or production facade exposes
it until `ProgramGraph` can lower that composition.
