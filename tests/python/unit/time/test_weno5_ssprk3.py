...
s_ref.block("gas", model=gas())  # spatial/time None -> Spatial() (minmod) + Explicit() (ssprk2)
...
# dans le test C++ tests/cpp/unit/numerics/test_weno5_ssprk3.cpp (acces direct a make_block / l'erreur analytique). Ici
