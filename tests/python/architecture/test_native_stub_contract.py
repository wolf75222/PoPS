...
PUBLIC_METADATA = {
    ...
    "__has_mpi__", "__mpi_include__", "__aux_named_base__", "__aux_max_extra__",
    "__aux_base_comps__", "__aux_max_comps__", "__max_runtime_params__", "__aux_canonical__",
}
PUBLIC_CALLABLES = {
    "abi_key", "my_rank", "n_ranks", "module_capabilities", "capability_report",
...
def test_public_native_stub_surface_is_closed_and_backed_by_cpp():
    ...
    native_metadata = set(re.findall(r'm\.attr\("([^"]+)"\)', native_source))
