...
NP>1 (manuel, hors pytest) : sur une machine avec h5py compile MPI + mpi4py, lancer
  `mpirun -n 2 python -c "import tests.python.integration.io.test_hdf5_parallel as t; t.manual_np_check()"`
(depuis la racine du repo, PYTHONPATH sur le build). manual_np_check() ecrit en parallel=True et verifie,
