...
static int pops_run_test_isothermal_vacuum_floor() {
  int fails = 0;
...
TEST(test_isothermal_vacuum_floor, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_isothermal_vacuum_floor, "test_isothermal_vacuum_floor"), 0);
}
