...
static int pops_run_test_lorentz_eliminator() {
  int fails = 0;
...
TEST(test_lorentz_eliminator, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_lorentz_eliminator, "test_lorentz_eliminator"), 0);
}
