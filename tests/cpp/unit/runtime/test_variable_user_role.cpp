...
static int pops_run_test_variable_user_role() {
  int fails = 0;
...
TEST(test_variable_user_role, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_variable_user_role, "test_variable_user_role"), 0);
}
