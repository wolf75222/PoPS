...
static int pops_run_test_public_validation_errors() {
...
TEST(test_public_validation_errors, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_public_validation_errors, "test_public_validation_errors"), 0);
}
