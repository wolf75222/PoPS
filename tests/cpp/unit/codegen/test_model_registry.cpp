...
static int pops_run_test_model_registry() {
  int fails = 0;
...
TEST(test_model_registry, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_model_registry, "test_model_registry"), 0);
}
