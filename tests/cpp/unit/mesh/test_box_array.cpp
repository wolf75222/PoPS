...
bool tiles_exactly(const BoxArray& ba, const Box2D& dom) {
...
TEST(test_box_array, divisible_domain_tiles_evenly) {
  ...
  EXPECT_TRUE(tiles_exactly(ba, dom)) << "div_tiles_exactly";
...
TEST(test_box_array, nondivisible_domain_splits_evenly) {
  ...
  EXPECT_TRUE(tiles_exactly(ba2, dom2)) << "ndiv_tiles_exactly";
