...
static int pops_run_test_numerical_defaults() {
...
TEST(test_numerical_defaults, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_numerical_defaults, "test_numerical_defaults"), 0);
}
