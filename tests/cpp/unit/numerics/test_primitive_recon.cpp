...
static int pops_run_test_primitive_recon() {
...
TEST(test_primitive_recon, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_primitive_recon, "test_primitive_recon"), 0);
}
