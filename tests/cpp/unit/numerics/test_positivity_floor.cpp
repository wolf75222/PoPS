...
static int pops_run_test_positivity_floor(int argc, char** argv) {
  comm_init(&argc, &argv);
...
TEST(test_positivity_floor, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_positivity_floor, "test_positivity_floor"), 0);
}
