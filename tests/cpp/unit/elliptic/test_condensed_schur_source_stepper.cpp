...
static int pops_run_test_condensed_schur_source_stepper(int argc, char** argv) {
  comm_init(&argc, &argv);
...
TEST(test_condensed_schur_source_stepper, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_condensed_schur_source_stepper, "test_condensed_schur_source_stepper"), 0);
}
