...
static int pops_run_test_schur_condensation() {
  int fails = 0;
...
TEST(test_schur_condensation, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_schur_condensation, "test_schur_condensation"), 0);
}
