...
static int pops_run_test_elliptic_composite_rhs() {
  int fails = 0;
...
TEST(test_elliptic_composite_rhs, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_elliptic_composite_rhs, "test_elliptic_composite_rhs"), 0);
}
