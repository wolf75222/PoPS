...
static int pops_run_test_generic_krylov() {
...
TEST(test_generic_krylov, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_generic_krylov, "test_generic_krylov"), 0);
}
