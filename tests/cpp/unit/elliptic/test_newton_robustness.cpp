...
static int pops_run_test_newton_robustness() {
...
TEST(test_newton_robustness, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_newton_robustness, "test_newton_robustness"), 0);
}
