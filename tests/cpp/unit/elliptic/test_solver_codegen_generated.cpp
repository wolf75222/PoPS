...
static int pops_run_test_solver_codegen_generated() {
...
TEST(test_solver_codegen_generated, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_solver_codegen_generated, "test_solver_codegen_generated"), 0);
}
