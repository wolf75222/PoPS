...
inline PopsConstFieldViewV1 const_field_view(const double* data, std::size_t ny, std::size_t nx,
                                             std::size_t components = 1,
                                             const char* layout_identity = "test::layout",
  ...
  return {
      ...
      2,
      {ny, nx, 1},
      {static_cast<std::ptrdiff_t>(nx * components), static_cast<std::ptrdiff_t>(components), 0},
      components,
      1,
...
inline PopsFieldViewV1 field_view(double* data, std::size_t ny, std::size_t nx,
                                  std::size_t components = 1,
                                  const char* layout_identity = "test::layout",
                                  const char* patch_identity = "test::patch") {
  return {
