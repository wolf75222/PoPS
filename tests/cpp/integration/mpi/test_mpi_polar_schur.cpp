...
static int pops_run_test_mpi_polar_schur(int argc, char** argv) {
  comm_init(&argc, &argv);
...
TEST(test_mpi_polar_schur, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_mpi_polar_schur, "test_mpi_polar_schur"), 0);
}
