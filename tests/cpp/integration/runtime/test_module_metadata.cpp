...
static int pops_run_test_module_metadata() {
...
TEST(test_module_metadata, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_module_metadata, "test_module_metadata"), 0);
}
