...
static int pops_run_test_config_model_validation(int argc, char** argv) {
#if defined(POPS_HAS_KOKKOS)
...
TEST(test_config_model_validation, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_config_model_validation, "test_config_model_validation"), 0);
}
