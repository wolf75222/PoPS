...
static int pops_run_test_checkpoint_cache() {
...
TEST(test_checkpoint_cache, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_checkpoint_cache, "test_checkpoint_cache"), 0);
}
