...
static int pops_run_test_system_hardening() {
  int fails = 0;
...
TEST(test_system_hardening, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_system_hardening, "test_system_hardening"), 0);
}
