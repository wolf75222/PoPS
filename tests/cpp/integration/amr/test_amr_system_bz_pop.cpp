...
static int pops_run_test_amr_system_bz_pop() {
  int fails = 0;
...
TEST(test_amr_system_bz_pop, Runs) {
  EXPECT_EQ(pops::test::RunTestBody(&pops_run_test_amr_system_bz_pop, "test_amr_system_bz_pop"), 0);
}
